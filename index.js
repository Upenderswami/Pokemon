...
//     data = await getDataFromAPI("https://pokeapi.co/api/v2/pokemon?limit=20&offset=0")
//     console.log(data);
...
// const warpper = document.querySelector('main');
...
//  function Inputfunction(u)
//  {
//     if (u.target.value.length === 0)
//         show(finaldata)
//         else
//     {
//         let forinput = finaldata
//         forinput = forinput.filter((obj) =>
//         obj.name.includes(u.target.value)
//         )
//     }
// show(forinput)
// }
 
// function selectfunction(u)
// {
//     const type = u.target.value
//     if(type === "all") show(finaldata)
// else{
//     let forinput = finaldata
//     forinput = forinput.filter((obj) =>
//         obj.types.name.includes(type)
//     )
// }
